...
- (void)viewDidLoad {
  [super viewDidLoad];
  // White so the safe-area bands (status bar / home indicator) around the
  // safe-area-inset LynxView match Misogram's white chrome (the feed, search,
  // profile pages are white; only Reels and the viewer are black).
